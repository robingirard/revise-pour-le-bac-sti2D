...
\begin{tikzpicture}[x=1cm,y=1cm,
  ...
  tension/.style={font=\scriptsize\bfseries},
...
\node[tension, text=solideD] at (1.25,0.45) {20 kV};
...
\node[tension, text=solideE] at (4.22,3.5) {400 kV};
\node[boite] (pt) at (4.22,1.85) {Poste de transformation};
\node[tension, text=solideE, font=\scriptsize] at (4.22,1.35) {225 kV -- 90 kV -- 63 kV};
\node[boite] (ps) at (4.22,0.85) {Poste source};
\node[tension, text=solideE] at (4.22,0.4) {20 kV};

%% ================== zone distribution =====================================
\pic at (6.4,2.6) {poteau};
\node[boite, font=\tiny, inner sep=1.5pt] at (7.25,2.75) {Transformateur\\de quartier};
\pic at (6.55,1.35) {maison};
\pic at (7.4,1.35) {maison};
\node[tension, text=solideF] at (6.95,2.0) {400 V};
\node[tension, text=solideF] at (6.95,0.75) {230 V};
\end{tikzpicture}
\end{document}
