...
%% vitesse croît proportionnellement au rayon (V = omega x R).
...
\node[font=\small, text=solideA, anchor=west] at (2.15,1.18) {$\vec{V}$};
...
\begin{scope}[rotate=\ang]
  \draw[|<->|, line width=0.5pt, black!70] (0,-0.80) -- (2.2,-0.80);
  \node[font=\small] at (1.1,-1.10) {$R$};
\end{scope}
