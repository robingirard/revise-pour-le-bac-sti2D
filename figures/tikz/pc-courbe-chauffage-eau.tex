...
\legformule{0.10}{-0.60}{1}{$Q_1 = m\,c_{\text{solide}}\,\Delta\theta$}
\legformule{2.55}{-0.60}{2}{$Q_2 = m\,L_{\text{fusion}}$}
\legformule{4.70}{-0.60}{3}{$Q_3 = m\,c_{\text{liquide}}\,\Delta\theta$}
\legformule{1.10}{-1.12}{4}{$Q_4 = m\,L_{\text{vaporisation}}$}
\legformule{4.00}{-1.12}{5}{$Q_5 = m\,c_{\text{gaz}}\,\Delta\theta$}
\node[font=\scriptsize, align=center, anchor=north] at (3.55,-1.45)
  {Chauffage à puissance constante : la longueur de chaque portion\\
   est proportionnelle à l'énergie reçue (1,0 kg d'eau, $Q = 3\,096$ kJ).};
\end{tikzpicture}
\end{document}
