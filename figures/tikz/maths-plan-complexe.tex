...
\node[font=\small, anchor=south east, inner sep=3pt] at (3.35,0.12) {axe réel};
...
\draw[-{Stealth[length=7pt]}, solideA, line width=1.4pt] (0,0) -- (\av,\bv)
     ...
     {$r=\left|z\right|$};
\draw[solideA, line width=1pt] (0.62,0) arc (0:36.87:0.62);
\node[font=\small, text=solideA, anchor=west, inner sep=1pt] at (0.66,0.26) {$\theta=\arg(z)$};
\draw[black!55, line width=0.9pt] (0.45,0) arc (0:-36.87:0.45);
\node[font=\small, text=black!55, anchor=west, inner sep=2pt] at (-19:0.52) {$-\theta$};
