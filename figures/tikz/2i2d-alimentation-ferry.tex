...
\node[bloc, text width=1.75cm] (bms) at (3.05,0.30) {Battery Management System};
...
\node[et, text=solideD, anchor=south] at (4.28,2.32) {Courant\\de charge};
\pastille{4.85}{2.60}{solideE}{$=$}
\pastille{4.85}{2.00}{solideE}{$=$}
...
%% ================= flux d'information ====================================
\draw[info] (3.97,0.30) -- (5.35,0.30) -- (5.35,1.15);
\node[et, text=solideB, anchor=west] at (4.06,0.12) {Mesures $U$, $I$, température};
