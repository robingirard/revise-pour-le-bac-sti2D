...
\useasboundingbox (-2.1,-2.8) rectangle (5.9,2.4);   % boîte fixe (animation : cm → SVG)
%% ======================= (a) vue de face =======================
% vis 1 : rectangle barré d'une croix, axe horizontal
\draw[axe] (-1.75,1.35) -- (1.75,1.35);
\draw[piece, solideA!95!black, fill=white] (-0.65,1.0) rectangle (0.65,1.7);   % vis vue de face : rotation invisible, reste fixe
\draw[piece, solideA!95!black] (-0.65,1.0) -- (0.65,1.7) (-0.65,1.7) -- (0.65,1.0);
...
\foreach \a in {74,82,...,106} {\draw[line width=0.7pt, solideB!95!black] ([shift=(\a:0.93)]0,0) -- ([shift=(\a:1.07)]0,0);}   % dents en prise : repère fixe
% rotation de la vis (autour de l'axe horizontal) et de la roue (dans le plan)
\draw[fleche, solideA!60] (-1.45,0.95) arc (-90:200:0.15 and 0.4);
\node[font=\small, text=solideA, anchor=north] at (-1.45,0.88) {$\omega_1$};
\draw[fleche, solideB!60] ([shift=(-70:1.3)]0,0) arc (-70:-20:1.3)
...
\begin{scope}[xshift=4.2cm]
  ...
  \draw[piece, solideB!95!black, fill=white] (-0.35,-1.0) rectangle (0.35,1.0);   % roue vue de côté : fixe
  ...
  \foreach \d in {-0.12,0,0.12} {\draw[line width=0.7pt, solideB!95!black] (\d,0.93) -- (\d,1.07);}
