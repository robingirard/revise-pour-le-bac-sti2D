...
\newcommand\etau{%
  \begin{scope}[line width=0.6pt, line join=round]
    ...
    \piece{1}{(0.8,0) -- (5.8,0) -- (5.8,2.7) -- (4.6,2.7) -- (4.6,3.4) -- (3.4,3.4) -- (3.4,0.7) -- (0.8,0.7) -- cycle}
    ...
    \piece{2}{(4.4,1.5) rectangle (5.3,2.5)}
    % 3 : mors mobile = bloc vertical + coulisse dans le canal
    \piece{3}{(1.6,0.95) -- (2.6,0.95) -- (2.6,1.0) -- (5.6,1.0) -- (5.6,1.4) -- (2.6,1.4) -- (2.6,3.4) -- (1.6,3.4) -- cycle}
    ...
    \piece{6}{(3.25,2.5) rectangle (3.4,3.3)}
    \piece{7}{(2.6,2.5) rectangle (2.75,3.3)}
    % 4 : vis de manœuvre (non coupée) : tête, collet, corps fileté, anneau d'arrêt
    \piece{4}{(1.0,1.6) rectangle (1.6,2.4)}
    \piece{4}{(1.6,1.8) rectangle (5.5,2.2)}
    \piece{4}{(2.6,1.7) rectangle (2.72,2.3)}
    ...
    \piece{5}{(1.17,0.55) rectangle (1.43,3.65)}
    \piece{5}{(1.08,0.45) rectangle (1.52,0.6)}
    \piece{5}{(1.08,3.6) rectangle (1.52,3.75)}
