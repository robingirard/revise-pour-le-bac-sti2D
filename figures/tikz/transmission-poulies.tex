...
\useasboundingbox (-1.9,-2.8) rectangle (6.3,2.5);   % boîte fixe (animation : cm → SVG)
...
\draw[poulie, solideA] (O1) -- ++(40:\ra);    % rayons : rendent la rotation visible
\draw[poulie, solideB] (O2) -- ++(140:\rb);
...
\draw[fleche, solideD!60!black] (0.6,1.05) -- (2.4,1.35);
\node[font=\small, text=solideD, anchor=south east] at (2.4,1.35) {$V$ courroie};
% --- Sens de rotation : identiques ---
\draw[fleche, solideA!60] ([shift=(-105:0.95)]O1) arc (-105:-175:0.95);   % sens horaire : le brin supérieur avance vers la droite
\node[font=\small, text=solideA, anchor=north east] at (-0.55,-0.95) {$\omega_1$};
\draw[fleche, solideB!60] ([shift=(-25:1.55)]O2) arc (-25:-85:1.55);
