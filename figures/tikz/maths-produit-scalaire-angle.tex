...
\coordinate (O) at (0,0);
\coordinate (U) at (12:3);      % u : long, presque horizontal
\coordinate (V) at (62:2);      % v : plus court, incliné d'environ 50° au-dessus de u
...
%% ---------------- l'égalité ----------------------------------------------
\node[font=\small, anchor=north, inner sep=2pt] at (1.55,-0.55)
