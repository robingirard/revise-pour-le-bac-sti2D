...
%% ================= panneau 1 : logique ================================
\begin{scope}[shift={(0,0)}, x=0.72cm, y=1cm]
...
\end{scope}
\node[titre] at (7.13,3.1) {Numérique};
\end{tikzpicture}
\end{document}
