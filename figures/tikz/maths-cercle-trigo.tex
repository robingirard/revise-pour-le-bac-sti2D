...
\node[font=\small, anchor=south east, inner sep=2pt] at (57.2958:1) {$M$};

%% ---------------- sens direct et sens indirect ------------------------
\draw[sens] (40:1.28) arc (40:128:1.28);
\node[font=\small, anchor=east, inner sep=2pt] at (-0.88,1.24) {$+$ sens direct};
\draw[sens, dash pattern=on 3pt off 2pt] (-40:1.28) arc (-40:-128:1.28);
\node[font=\small, anchor=east, inner sep=2pt] at (-0.88,-1.24) {sens indirect};
\end{tikzpicture}
\end{document}
