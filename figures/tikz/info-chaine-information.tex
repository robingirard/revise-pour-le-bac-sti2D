...
\begin{tikzpicture}[x=1cm,y=1cm,
  bloc/.style={draw=solideB, line width=1.2pt, rounded corners=4pt, fill=white,
               minimum width=2.15cm, minimum height=1.9cm, inner sep=3pt,
...
\node[bloc] (tra) at (2.55,0) {\textbf{TRAITER}\\[3pt] carte\\ Arduino\\ automate};
\node[bloc] (com) at (5.1,0)  {\textbf{COMMUNIQUER}\\[3pt] voyants, écran\\ relais,\\ transistors\\ réseau};
...
%% ---- entrée et sortie ------------------------------------------------
\draw[fleche] (-2.5,0) -- (acq.west);
\node[bord, align=right, anchor=south east] at (-1.5,0.12) {Grandeurs physiques, consignes};
\draw[fleche] (com.east) -- (7.6,0);
\node[bord, align=left, anchor=south west] at (6.55,0.12) {Informations (ordres, messages)};
\end{tikzpicture}
\end{document}
