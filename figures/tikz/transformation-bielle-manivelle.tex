...
\coordinate (B) at (3.42,0);
% --- Trajectoire du point A (cercle) et angle theta ---
\draw[line width=0.6pt, dashed, draw=S1!70] (O) circle (1.2);
\draw[axe] (-1.6,0) -- (5.6,0);
\draw[line width=0.7pt, draw=S1] (0.62,0) arc (0:55:0.62);
\node[font=\small, text=S1, anchor=west, inner sep=1.5pt] at (27:0.72) {$\theta$};
% --- Guidage du piston (bâti) : deux traits hachurés ---
\foreach \x in {2.85,3.05,...,5.05} {\draw[line width=0.5pt] (\x,0.5) -- (\x-0.14,0.64)
   (\x,-0.5) -- (\x-0.14,-0.64);}
\draw[line width=0.8pt] (2.7,0.5) -- (5.05,0.5) (2.7,-0.5) -- (5.05,-0.5);
% --- Symboles de liaison ---
...
\begin{scope}[on background layer]
  ...
  \draw[solide, S3, fill=white] (2.82,-0.42) rectangle (4.02,0.42);   % piston 3
\end{scope}
% --- Mouvements ---
\draw[fleche, S1] ([shift=(60:0.81)]O) arc (60:142:0.81);
\node[font=\small, text=S1, anchor=east, inner sep=2pt] at (-0.7,0.42) {$\omega$};
\draw[{Stealth[length=5pt]}-{Stealth[length=5pt]}, line width=0.8pt, S3] (3.0,-0.95) -- (4.6,-0.95);
\node[font=\small, text=S3, anchor=north] at (3.8,-1.05) {translation alternative};
...
\node[font=\small, text=S3, anchor=south] at (4.05,0.78) {\textbf{3} piston};
