...
\begin{scope}[shift={(0,0)}]
  ...
  \draw[force] (-0.85,0) -- (-1.45,0) node[font=\small, text=solideA, anchor=south, inner sep=2pt] {$F$};
  \node[titre] at (0,-0.45) {\textbf{1.} la pièce\\ est tendue};
\end{scope}
\draw[etape] (1.72,0) -- (2.18,0);
...
\begin{scope}[shift={(3.35,0)}]
  ...
  \node[titre] at (-0.1,-0.55) {\textbf{2.} coupure imaginaire :\\ on isole un tronçon};
\end{scope}
\draw[etape] (4.9,0) -- (5.36,0);
...
\begin{scope}[shift={(6.2,0)}]
  ...
  \node[titre] at (0.2,-0.72) {\textbf{3.} l'effort $N$ se\\ répartit sur $S$};
\end{scope}

%% ------------------------- cartouche --------------------------------
\node[draw=black!45, fill=black!3, rounded corners=3pt, inner sep=5pt, anchor=north,
      font=\small, align=center] at (2.9,-1.62)
