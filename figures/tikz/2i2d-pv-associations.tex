...
%% ================= 2. SÉRIE-PARALLÈLE ====================================
\node[titre] at (2.55,3.45) {Série-parallèle};
...
%% ================= tableau de synthèse ===================================
\foreach \x/\u/\i in {0.55/18/{22{,}24}, 2.55/36/{11{,}12}, 6.0/72/{5{,}56}} {
...
\node[font=\scriptsize, anchor=north, align=flush center, text=black!65, text width=6.6cm]
  at (3.28,-1.72)
  {valeurs exactes 400,3 W ; le manuel arrondit le courant à 22,2 A puis écrit 400 W};
\end{tikzpicture}
\end{document}
