...
\node[lab, text=solideB!70!black, anchor=west, fill=white] at (0.15,2.25) {\textbf{3} Z3 = 50};
\node[lab, text=solideB!70!black, anchor=west, fill=white] at (0.15,1.90) {Z3$'$ = 12};
