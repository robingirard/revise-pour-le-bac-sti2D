...
%% ---------- note de lecture ----------------------------------------------
\node[font=\scriptsize, anchor=north, align=center, text=black!65, text width=6.2cm]
  at ({\xp{50}},-0.84)
  {tensions de départ (58 V et 56 V) lues sur le graphique\\ du manuel, qui ne les imprime pas};
\end{tikzpicture}
\end{document}
