...
\begin{scope}[x=0.175cm, y=0.19cm]
  ...
  \draw[guide] (16,13) -- (16,1.6);
  \draw[guide] (21,7) -- (21,1.6);
  \draw[cote] (16,1.6) -- (21,1.6);
\end{scope}
...
\node[txt, anchor=north, text=black!75, fill=white, inner sep=1pt]
  at ({18.5*0.175},{1.5*0.19}) {déphasage ($\approx 5$ h)};
...
\node[txt, anchor=north, align=center] at (3.5,-1.05)
  {allures qualitatives ; l'inertie ne supprime pas l'énergie entrante,\\
   elle la retarde et l'amortit};
\end{tikzpicture}
\end{document}
