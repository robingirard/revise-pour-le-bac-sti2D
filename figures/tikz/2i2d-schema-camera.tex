...
\begin{tikzpicture}[x=1cm,y=1cm,
  ...
  legg/.style={font=\scriptsize, anchor=east, align=right, text width=2.3cm, inner sep=2pt,
               execute at begin node={\hyphenpenalty=10000\exhyphenpenalty=10000}},
  mixte/.style={-{Stealth[length=5pt]}, line width=0.6pt,
                dash pattern=on 6pt off 2pt on 1pt off 2pt}]

%% ================== bâti 0 ============================================
\hachures[draw=solideA]{(2.1,5.95) rectangle (4.1,6.15)}
\draw[solideA, line width=0.9pt] (2.1,5.95) rectangle (4.1,6.15);
\draw[amorce] (4.1,6.05) -- (4.95,6.05);
\node[legd] at (4.95,6.05) {\textbf{Bâti 0} : plateau 3 + tiges 2 + platine 1};

%% ================== liaison pivot d'axe (O,z) =========================
\draw[solideA, line width=1.1pt] (2.35,5.95) -- (2.35,4.75) -- (2.75,4.75);
...
\node[font=\scriptsize, anchor=north] at (4.8,1.42)
     {\textbf{2} : module caméra 27 + chape 10 + roue 13};

%% ================== repère (x, y, z) ==================================
\draw[mixte] (1.2,1.45) -- (1.2,2.25) node[anchor=south, inner sep=1pt, font=\small] {$\vec{z}$};
\draw[mixte] (1.2,1.45) -- (2.0,1.35) node[anchor=west, inner sep=1pt, font=\small] {$\vec{y}$};
\draw[mixte] (1.2,1.45) -- (0.6,0.95) node[anchor=north east, inner sep=1pt, font=\small] {$\vec{x}$};

%% ================== encadré de conclusion =============================
\node[draw=solideA, line width=0.9pt, fill=solideA!7, rounded corners=3pt, inner sep=4pt,
      font=\scriptsize, anchor=north, text width=7.2cm, align=center] at (4.2,0.85)
