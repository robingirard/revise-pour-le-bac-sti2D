...
\foreach \yl/\cible/\txt in {1.95/cArdoise/{Ardoise --- 0,003},
  ...
  \node[etiq] (e) at (-0.85,\yl) {\txt};
  \draw[rappel] (-0.80,\yl) -- (\cible); }
...
\rappel{\node[font=\small] at (1.20,\yf) {$=$};
\node[draw=solideD, line width=0.8pt, rounded corners=2pt, fill=solideD!8,
      font=\scriptsize, inner sep=4pt, anchor=west] at (1.38,\yf)
  {$R_{\text{th}} = 5{,}906$ m$^2\cdot$K$\cdot$W$^{-1}$};

\node[font=\scriptsize, anchor=north, align=center] at (-0.40,-1.62)
